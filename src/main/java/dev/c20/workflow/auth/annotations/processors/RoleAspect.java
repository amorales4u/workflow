package dev.c20.workflow.auth.annotations.processors;

import dev.c20.workflow.auth.annotations.RoleException;
...
*/
    ...
    @Before("@annotation(dev.c20.workflow.auth.annotations.Roles) && args(request,..)")
