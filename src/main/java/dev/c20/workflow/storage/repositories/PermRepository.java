...
public interface PermRepository extends JpaRepository<Perm, Long> {
    ...
    @Query( "select s.path from Perm o, Storage s where o.parent = s and s.path like '/Workflows/%' and s.level = 1 and o.user in ( ?1 ) and ( o.canAdmin = true  or o.canRead = true or o.canSend = true  ) order by s.path")
